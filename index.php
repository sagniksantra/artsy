         ...
         <div class="container py-lg-5 py-md-5 py-sm-4 py-4">
            ...
            <div class="row banner-below-w3l">
               <div class="col-lg-4 col-md-6 col-sm-6 text-center banner-agile-flowers">
                  <img src="https://i.ibb.co/3CmZMMf/sculpture.jpg" width="200" height="200" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Sculptures</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 text-center banner-agile-flowers">
                  <img src="https://i.ibb.co/gSKjHz6/seri.jpg" width="200" height="200" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
               ...
               <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
                  <img src="https://i.ibb.co/ZTW2Htk/paintings.jpg" width="200" height="200" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Painting</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
                  <img src="https://i.ibb.co/599P6WK/streetart.jpg" width="200" height="200" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
